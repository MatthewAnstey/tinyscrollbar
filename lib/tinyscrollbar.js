;(function(window, undefined) {
    ...
    function Plugin($container, options) {
        ...
        ,   $arrowUp = $container.querySelectorAll(".arrowup")[0]
        ,   $arrowDown = $container.querySelectorAll('.arrowdown')[0]
        ...
        function _setEvents() {
            ...
            $arrowDown.onclick = function(event) {
                if (this.contentPosition + this.viewportSize +
                    this.increment < this.contentSize) {
